...
export default function LoadingScreen({ onFinish }) {
  ...
  // Map bgTransition value to opacity of second background
  const secondBgOpacity = bgTransition;
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[StyleSheet.absoluteFill, { opacity: secondBgOpacity }]}>
        <LinearGradient
      ...
      <View style={styles.content}>
        ...
        {/* Tagline Urdu: "آپ کی خدمت میں حاضر ہیں" */}
        <Animated.Text style={[styles.tagline, { opacity: taglineFade }]}>
          آپ کی خدمت میں حاضر ہیں
        </Animated.Text>

        {/* Tagline English: "AI Service Orchestrator" */}
